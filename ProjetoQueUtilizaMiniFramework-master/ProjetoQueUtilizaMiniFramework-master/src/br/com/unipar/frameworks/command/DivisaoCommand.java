...
public class DivisaoCommand implements CommandHandler {
    @Override
    public Response handle(Request request) {
        if (request.getArgs().size() < 2) {
            return Response.badRequest("Uso deve ser: divisao <num1> <num2>");
        }
        ...
        try {
            ...
            if (num2 == 0) {
                return Response.badRequest("Não é possível dividir por zero.");
            }
